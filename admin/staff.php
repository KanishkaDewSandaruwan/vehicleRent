            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#StaffModal">Add New</button>
                        </div>
                    </div>
                                ...
                                while($row=mysqli_fetch_assoc($getall)){ 
                                  ...
                                  ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>  <a href="staff_edit.php?staff_id=<?php echo $staff_id; ?>"
                                                    class="btn btn-darkblue"> <i class="fa-solid fa-edit"></i>
                                                </a>
                                                
                                            <button type="button"
                                                    onclick="deleteData(<?php echo $row['staff_id']; ?>,'staff', 'staff_id')"
        ...
        <div class="modal-content bg-dark">
            ...
            <form action="" method="post" id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                ...
                <div class="modal-footer bg-dark">
                    ...
                    <button type="button" onclick="addStaff(this.form)" name="submit" class="btn btn-primary">Save
                        changes</button>
                </div>
            </form>
