                        ...
                        <div class="col-12 col-lg-6 col-xxl-6 d-flex">
                            <div class="card flex-fill">
                                ...
                                if (isset($_REQUEST['driver_id'])) {
                                    $getall = getDriverByID($_REQUEST['driver_id']);
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input id="inputName" type="text" name="name" data-parsley-trigger="change"
                                        onchange="updateData(this, '<?php echo $driver_id; ?>', 'name', 'driver', 'driver_id');"
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input id="inputEmail" type="email" name="email" data-parsley-trigger="change"
                                        onchange="updateData(this, '<?php echo $driver_id; ?>', 'email', 'driver', 'driver_id');"
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input id="inputPhone" type="text" name="phone" data-parsley-trigger="change"
                                        ...
                                        onchange="updateData(this, '<?php echo $driver_id; ?>', 'phone', 'driver', 'driver_id');"
                                        value="<?php echo $row['phone']; ?>" class="form-control">
                                </div>
                                <div class="form-group mt-2">
                                    <label for="inputNIC">NIC</label>
                                    <input id="inputNIC" type="text" name="nic" data-parsley-trigger="change"
                                        onchange="updateData(this, '<?php echo $driver_id; ?>', 'nic', 'driver', 'driver_id');"
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input id="inputAddress" type="text" name="address" data-parsley-trigger="change"
                                        onchange="updateData(this, '<?php echo $driver_id; ?>', 'address', 'driver', 'driver_id');"
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        onchange='updateData(this, "<?php echo $driver_id; ?>","gender", "driver", "driver_id")'
                                        id="gender <?php echo $driver_id; ?>" class='form-control norad tx12'
                                ...
                                <div class="col-md-4 mt-2">
                                    <div class="row mt-2">
                                        <a href="driver.php" class="btn btn-info">Back</a>
                                    </div>
                                </div>
