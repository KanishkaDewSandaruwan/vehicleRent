                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="product p-4">
                                    ...
                                    <div class="mt-4 mb-3">
                                        <h5 class="text-uppercase"> <?php echo $row['package_name']; ?></h5>
                                        <div class="price d-flex flex-row align-items-center"> 
                                            <span class="act-price">Package Price : Rs. <?php echo $row['package_price']; ?>.00</span><br/>
                                        </div>
                                        <span class="">Vehicle Type : <?php $value = getAllCategoryByID($row['cat_id']); $row2 = mysqli_fetch_assoc($value); echo $row2['cat_name']; ?></span>
                                    </div>
                                    <p class="about">  <?php echo $row['package_details']; ?></p>
                 
                                    
                                    <div class="cart mt-4 align-items-center"> <a href="vehicle_booking.php?package_id=<?php echo $package_id; ?>"  class="btn btn-danger text-uppercase mr-2 px-4">Book This Package</a> </div>
                                </div>
                            </div>
                        </div>
                    </div>
